...
class SetNet(nn.Module):
    def __init__(self, hidden_dim):
        ...
        #SetBlock(forward_block, pooling=False)
        ...
        self.fc_bin = nn.ParameterList([
            nn.Parameter(#将一个不可训练的类型Tensor转换成可以训练的类型parameter torch.nn.Parameter(torch.FloatTensor(hidden_size))
                nn.init.xavier_uniform_(#均匀分布
