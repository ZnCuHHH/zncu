...
class Model:
    def __init__(self,
                 ...
                 restore_iter,#0
                 total_iter,#80000
                 save_name,#GaitSet_CASIA-B_73_False_256_0.2_128_full_30
                 train_pid_num,#73
                 frame_num,#30
                 model_name,#GaitSet
                 train_source,#<model.utils.data_set.DataSet object at 0x000002455C1EB040>
                 test_source,#<model.utils.data_set.DataSet object at 0x000002455C229040>
                 img_size=64):

        self.save_name = save_name#GaitSet_CASIA-B_73_False_256_0.2_128_full_30
        self.train_pid_num = train_pid_num#73
        self.train_source = train_source#<model.utils.data_set.DataSet object at 0x000002455C1EB040>
        self.test_source = test_source#<model.utils.data_set.DataSet object at 0x000002455C229040>
        ...
        self.encoder = SetNet(self.hidden_dim).float()#SetNet
        ...
        self.optimizer = optim.Adam([#激励函数
    ...
    def fit(self):
        if self.restore_iter != 0:#restore_iter = 0
        ...
        train_loader = tordata.DataLoader(
            ...
            num_workers=self.num_workers)#num_workers=0:数据导入在主进程中进行
